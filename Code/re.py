...
def update_warehouse(warehouse, rack, item, quantity): 
...
def test_warehouse(warehouse): 
	warehouse = update_warehouse(warehouse, 3, 1, 10) 
	warehouse = update_warehouse(warehouse, 5, 3, 10) 
	warehouse = update_warehouse(warehouse, 9, 2, 10) 
	warehouse = update_warehouse(warehouse, 11, 5, 10) 
	warehouse = update_warehouse(warehouse, 1, 4, 10) 
	return warehouse 
def test(): 
	warehouse = {} 
